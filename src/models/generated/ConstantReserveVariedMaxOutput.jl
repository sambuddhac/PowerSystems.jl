...
mutable struct ConstantReserve{T <: ReserveDirection} <: Reserve{T}
    ...
    max_output_fraction::Vector{Float64}
...
function ConstantReserve{T}(name, available, time_frame, requirement, sustained_time=3600.0, max_output_fraction=Vector{Float64}(), max_participation_factor=1.0, deployed_fraction=0.0, ext=Dict{String, Any}(), ) where T <: ReserveDirection
...
function ConstantReserve{T}(; name, available, time_frame, requirement, sustained_time=3600.0, max_output_fraction=Vector{Float64}(), max_participation_factor=1.0, deployed_fraction=0.0, ext=Dict{String, Any}(), internal=InfrastructureSystemsInternal(), ) where T <: ReserveDirection
